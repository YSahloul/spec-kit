#!/bin/bash
# Create a new OpenCode feature with branch, directory structure, and template
# Usage: ./create-new-feature.sh "feature description"
#        ./create-new-feature.sh --json "feature description"
# Note: Optimized for OpenCode CLI integration
...
TEMPLATE="$REPO_ROOT/.opencode/templates/spec-template.md"
